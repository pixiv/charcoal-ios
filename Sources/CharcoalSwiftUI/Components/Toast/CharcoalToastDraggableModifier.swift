...
extension View {
    func charcoalDraggableToast(screenEdge: CharcoalPopupViewEdge,
                                isPresenting: Binding<Bool>,
                                offset: Binding<CGSize>,
                                dragVelocity: Binding<CGSize>,
                                isDragging: Binding<Bool>) -> some View {
        self.modifier(CharcoalToastDraggableModifier(screenEdge: screenEdge,
