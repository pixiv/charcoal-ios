...
private let fontSize = CGFloat(CharcoalFoundation.Typography.textFontSize1.value)
private let lineHeight = CGFloat(CharcoalFoundation.Typography.textLineHeight1.value)
