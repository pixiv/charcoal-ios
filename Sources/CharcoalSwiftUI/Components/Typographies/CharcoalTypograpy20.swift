...
private let fontSize = CGFloat(CharcoalFoundation.Typography.textFontSize30.value)
private let lineHeight = CGFloat(CharcoalFoundation.Typography.textLineHeight30.value)
