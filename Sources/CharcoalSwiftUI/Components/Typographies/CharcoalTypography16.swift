...
private let fontSize = CGFloat(CharcoalFoundation.Typography.fontSize10.value)
private let lineHeight = CGFloat(CharcoalFoundation.Typography.lineHeight10.value)
